...
public class SPARQLQueryBuilderTest extends TestCase {
    public void testEvalRun() {
        ...
        assertThat(sparql.createEvalBuilder(QueryBuilder.ExecMode.Run, 7.0), is(Function.SEM_SPARQL_70));
        assertThat(sparql.createEvalBuilder(QueryBuilder.ExecMode.Run, 8.0), is(Function.SEM_SPARQL_70));
        assertThat(sparql.createEvalBuilder(QueryBuilder.ExecMode.Run, 9.0), is(Function.SEM_SPARQL_70));
    }
