...
class MarkLogicAppServerTest : TestCase() {
    fun testSystem() {
        val appserver = MarkLogicAppServer.SYSTEM
    ...
    fun testAppServer() {
        val appserver = MarkLogicAppServer("Default", "test", "HTTP", 8020)
    ...
    fun testTaskServer() {
        val appserver = MarkLogicAppServer.TASKSERVER
