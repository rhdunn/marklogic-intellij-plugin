...
class SPARQLUpdateBuilderTest : TestCase() {
    fun testEvalRun() {
        val sparql = SPARQLUpdateBuilder
        ...
        assertThat<Function>(sparql.createEvalBuilder(DefaultRunExecutor.EXECUTOR_ID, MARKLOGIC_7), `is`(nullValue()))
        assertThat<Function>(sparql.createEvalBuilder(DefaultRunExecutor.EXECUTOR_ID, MARKLOGIC_8), `is`(Function.SEM_SPARQL_UPDATE_80))
        assertThat<Function>(sparql.createEvalBuilder(DefaultRunExecutor.EXECUTOR_ID, MARKLOGIC_9), `is`(Function.SEM_SPARQL_UPDATE_80))
    }
